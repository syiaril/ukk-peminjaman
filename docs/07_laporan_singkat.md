...
| Pengajuan peminjaman            | ✅ Berjalan  | Input jumlah + durasi (maks 3 hari), auto-hitung tanggal wajib kembali |
| Persetujuan oleh petugas/admin  | ✅ Berjalan  | Via stored procedure + auto kurangi stok sesuai jumlah (trigger) |
...
| Konfirmasi pengembalian         | ✅ Berjalan  | Via stored procedure + auto tambah stok sesuai jumlah (trigger) |
...
| Trigger kurangi stok            | ✅ Berjalan  | `stok = stok - jumlah`, otomatis saat peminjaman disetujui |
| Trigger tambah stok             | ✅ Berjalan  | `stok = stok + jumlah`, otomatis saat alat dikembalikan    |
...
| Aspek                    | Status                                |
|--------------------------|---------------------------------------|
| Fitur berjalan baik      | **24+ fitur** — semua fitur inti ✅    |
...
*Dokumen ini merupakan Laporan Evaluasi Singkat Proyek UKK — Aplikasi Peminjaman Alat Sekolah*
*Tanggal: April 2026*
